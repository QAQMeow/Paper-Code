# -*- coding: utf-8 -*-
"""
Created on Sat May 24 12:40:30 2025
...
lab2 = ['health expenditure(%)','emission intensity(t/$)','access to electricity(%)','cook without clean fuels(%)']
...
AData = [A['a1'].T,A['a2'].T,A['a3'].T,A['a4'].T]
RD =[]
for j in range(4):
    RData = {}
...
fig, axs = plt.subplots(ncols=5, nrows=4, figsize=(width_inch , height_inch ),
...
YL = np.array([[-0.01,30],[-0.01,250],[0,100],[0,100]])
for col in range(5):
    for row in range(4):
        if col <4:
