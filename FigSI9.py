# -*- coding: utf-8 -*-
"""
Created on Sat May 24 12:33:25 2025
...
lab2 = ['tobacco use(%)','obesity(%)','occupational pollution(%)','old population(%)']
...
AData = [V['v1'].T,V['v2'].T,100*V['v3'].T,V['v4'].T]
RD =[]
for j in range(4):
    RData = {}
...
YL = np.array([[-0.01,50],[-0.01,50],[0,20],[0,25]])
for col in range(5):
    for row in range(4):
        if col <4:
